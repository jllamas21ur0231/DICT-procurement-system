...
const NAV_ITEMS = [
    { label: "Dashboard", icon: <DashboardIcon />, to: "/sadmin/dashboard" },
    { label: "Users", icon: <UsersIcon />, to: "/sadmin/users" },
    { label: "Procurement", icon: <ProcurementIcon />, to: "/sadmin/procurement" },
    { label: "Purchase Request", icon: <PurchaseIcon />, to: "/sadmin/purchase-request" },
];
